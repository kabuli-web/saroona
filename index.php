                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4>
                                                        <?php echo $language['your_card_url_title']; ?>
                                                    </h4>
                                                    <?php
                                                    $host = (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'];
                                                    $enroll_link = $host ."/saroona". "/enroll-customer.php?campaign_id=" . $campaignId;
                                                    ?>
                                                    <a href="<?php echo $enroll_link; ?>"><?php echo $enroll_link; ?> </a>
