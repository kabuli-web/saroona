         ...
         <div class="d-flex">
             ...
             <div class="navbar-brand-box">
                 <a href="index.php" class="logo logo-dark">
                     ...
                     <span class="logo-lg">
                         <img src="assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">Kabuli</span>
                     </span>
                 </a>
         ...
         <div class="d-flex">
             ...
             <div class="dropdown d-inline-block language-switch">
                 ...
                 <?php
                        if (!empty($_SESSION['lang'])) {
                            ...
                            if ($lang == "en") {
                                ...
                                $imgPath = 'assets/images/flags/arabic.jpg';}
                 ...
                 <div class="dropdown-menu dropdown-menu-end">
                     ...
                     <!-- item-->
                     <a href="?lang=en" onclick="changeLanguage('en')" class="dropdown-item notify-item language" data-lang="eng">
                         <img src="assets/images/flags/us.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                     </a>
                    
                     <!-- item-->
                     <a href="?lang=ar" onclick="changeLanguage('ar')" class="dropdown-item notify-item language" data-lang="ar">
                         <img src="assets/images/flags/arabic.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Arabic</span>
                     </a>
                 </div>
             </div>
