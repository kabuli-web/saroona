    ...
    console.log("<?php echo $_GET["id"] ?>")
        ...
        <div class="page-content">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (isset($_POST["post_type"]) && $_POST["post_type"] == "delete_card" && isset($_POST["card_id"])) {
                    ...
                    $curl = curl_init();
                    curl_setopt_array($curl, array(
                        CURLOPT_URL => "https://api.loopyloyalty.com/v1/card/cid/$card_id/delete",
                        CURLOPT_RETURNTRANSFER => true,
                        CURLOPT_ENCODING => '',
                        CURLOPT_MAXREDIRS => 10,
                        CURLOPT_TIMEOUT => 0,
                        ...
                        if ($http_status == 200) {
                            ...
                            if ($decoded_response === null) {
                                ...
                                if ($decoded_response["success"]) {
                                    ...
                                    // Redirect to the same page to prevent form resubmission
                                    header("Location: " . htmlspecialchars($users_link));
                                    exit(); // Ensure that further code is not executed

                                } else {
                                    header("Location: " . htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $_GET["id"] . '&card_deleted=0');
                                    exit(); // Ensure that further code is not executed;
                                }
                            }
                            // You can parse and manipulate the response data here
            ...
            if (!isset($page_error)) {
                ...
                <style>
                    ...
                    .loyalty-card {
                        ...
                        min-height: 140px;
                        padding: 2px;
                        background-color: <?php echo $user_data['stripImage']['backgroundColor'] ?>;
                        /* Background color from the provided data */
                        display: flex;
                        align-items: center;
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-danger waves-effect waves-light w-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                            <i class="mdi mdi-trash-can d-block font-size-16"></i> <?php echo $language['delete_user']; ?>
                                        </button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="staticBackdropLabel"><?php echo $language['delete_user']; ?></h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <?php $post_delete_url = htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $_GET["id"]; ?>
                                                        <form action="<?php echo $post_delete_url ?>" method="post">
                                                            ...
                                                            <button type="submit" class="btn btn-danger"><?php echo $language['confirm_delete_user']; ?></button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
