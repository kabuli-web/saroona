                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="/"><?php echo $language["Dashboard"]; ?></a></li>
                                    <li class="breadcrumb-item"><a href="/users"><?php echo $language["users"];; ?></a></li>
    ...
    $(document).ready(function() {
        ...
        function initDataTable() {
            ...
            "columns": [
                ...
                { "data": "status","title":"3" },
                { "data": "totalStampsEarned","title":"4" },
                { "data": "totalRewardsEarned","title":"5" },
                { "data": "totalRewardsRedeemed" ,"title":"6"},
                {
                    "data": "id",
                    "render": function(data, type, row) {
                        return '<a href="/user-details.php?id='+row["id"] +'"><button type="button" class="btn btn-primary waves-effect waves-light">' +
