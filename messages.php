            ...
            if ($http_status == 200) {
                ...
                if ($decoded_response === null) {
                    ...
                    if($decoded_response["success"]){
                        ...
                        header("Location: " . htmlspecialchars($_SERVER["PHP_SELF"]) . '?message_sent=1');
                        exit(); // Ensure that further code is not executed
                        
                    }else{
                        header("Location: " . htmlspecialchars($_SERVER["PHP_SELF"]) . '?message_sent=0');
                        exit(); // Ensure that further code is not executed;
                    }
                }
